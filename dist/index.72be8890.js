document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePagination(index) {
        ...
        if (firstSpan) firstSpan.textContent = `0${currentIndex}`;
    }
    updatePagination(swiper.realIndex);
    // gsap our story
    ...
    const products = [
        {
            img: './img/main-product02.jpg',
            name: 'Beosound A5',
            price: "From \u20A92,090,000"
        },
        {
            img: './img/main-product03.jpg',
            name: 'Beosound A5',
            price: "From \u20A92,090,000"
        },
        {
            img: './img/main-product04.jpg',
            name: 'Beosound A5',
            price: "From \u20A92,090,000"
        },
        {
            img: './img/main-product05.jpg',
            name: 'Beosound A5',
            price: "From \u20A92,090,000"
        },
        {
            img: './img/main-product06.jpg',
            name: 'Beosound A5',
            price: "From \u20A92,090,000"
        },
        {
            img: './img/main-product07.jpg',
            name: 'Beosound A5',
            price: "From \u20A92,090,000"
        },
        {
            img: './img/main-product08.jpg',
            name: 'Beosound A5',
            price: "From \u20A92,090,000"
        }
    ];
